...
import org.junit.Assert;
 ...
 public class Login_StepDefs {
    ...
    public void validate_that_warning_message_appears() {
     ...
     @Then("Validate that warning message appears {string}")
     public void validateThatWarningMessageAppears(String message) {

        String expectedMessage=message;
        String actualMessage=loginPage.getWarningElementText();
