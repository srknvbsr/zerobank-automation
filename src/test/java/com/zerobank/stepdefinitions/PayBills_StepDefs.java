...
public class PayBills_StepDefs {
    ...
    @When("User send {string} amount to input box")
    public void user_send_amount_to_input_box(String string) {
        payBillsPage.sendAmount(string);

    }
    @When("User send {string} date to input box")
    public void user_send_date_to_input_box(String string) {
    ...
    public void validate_that_success_message_is_visible() {
        String actual = payBillsPage.getSuccesMessageText();
